...
Размер хеш-индексов тоже примерно одинаковый.
А размер btree-индексов зависит от размера индексируемого поля, поскольку такие индексы хранят индексируемые значения.
